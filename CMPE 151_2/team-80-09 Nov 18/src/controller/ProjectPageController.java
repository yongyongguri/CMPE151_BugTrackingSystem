...
/**
 * This class provides the controls for the project page of the application.
 */
public class ProjectPageController implements Initializable {

	@FXML private Label isDatabaseConnected;
	@FXML private AnchorPane createNewProject_page;
	@FXML private TextField addProjectName;
	@FXML private DatePicker addProjectDate;
	@FXML private TextArea addProjectDescription;
	@FXML private TextField addProjectLevel;
	@FXML private Button addProject_saveButton;
	@FXML private Button addProject_cancelButton;
	@FXML private TableView<NewProjectData> project_tableView;
	@FXML private TableColumn<NewProjectData, String> add_projectName_column;
	@FXML private TableColumn<NewProjectData, String> add_ProjectDate_Column;
	@FXML private TableColumn<NewProjectData, String> add_ProjectDescription_Column;
	@FXML private TableColumn<NewProjectData, String> add_ProjectLevel_Column;
	@FXML private TableColumn<NewProjectData, String> ProjectID_TableColumn;
	@FXML private Button addProject_clearButton;
	
	public DataModel dataModel = new DataModel();
	/**
	 * Initialize to display the stored projects using UpdateTable() 
	 * and the current date in the DatePicker using showDate().
	 */
	@Override
	...
	/**
	 * Adds a New Project with name, staring date, description, and risk level. 
